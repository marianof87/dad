...
Write-Host "🌐 Creando red Docker 'mi-network'..." -ForegroundColor Cyan
...
Write-Host ""
Write-Host "✅ Contenedores creados en 'mi-network':" -ForegroundColor Green
...
Write-Host ""
Write-Host "⚠️  Nota sobre portabilidad:" -ForegroundColor Yellow
Write-Host "   run.sh   → Funciona en Linux/macOS (bash)"
Write-Host "   docker-run.ps1 → Funciona en Windows (PowerShell)"